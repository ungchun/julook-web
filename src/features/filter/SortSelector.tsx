...
import { SortInfoDialog } from "./SortInfoDialog";
...
// iOS SortOptionsView Menu+Picker 미러 — native select 로 단순화.
// 좌측: "어떤 순서로 정렬되나요" 안내 + (?) 클릭 시 현재 정렬 설명 dialog.
  ...
  return (
    <>
      <div className={styles.wrap}>
        ...
        >
          <span className={styles.infoText}>어떤 순서로 정렬되나요</span>
          <span aria-hidden className={styles.infoIcon}>
            ?
          </span>
        </button>
